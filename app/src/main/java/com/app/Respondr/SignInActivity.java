...
public class SignInActivity extends AppCompatActivity {
    ...
    private MaterialButton btnSignIn, btnGoogleSignIn, btnPhoneAuth;
    ...
    private void configurePhoneAuth() {
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull com.google.firebase.FirebaseException e) {
                ...
                hideProgress();
                Toast.makeText(SignInActivity.this, "Phone verification failed: " + e.getMessage(), Toast.LENGTH_LONG).show();
            }
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(SignInActivity.this, "Phone authentication failed: " + task.getException().getMessage(),
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Log.w(TAG, "signInWithCredential:failure", task.getException());
                        Toast.makeText(SignInActivity.this, "Google authentication failed: " + task.getException().getMessage(),
                                Toast.LENGTH_SHORT).show();
                    }
                });
    }
